export default {
  ...
  settings: {
    ...
    plugins: {
      ...
      uiuxDesc: 'AI-powered UI/UX design system generator with professional design intelligence',
      ...
      uiuxStyles: '57 UI styles + 95 color palettes',
      uiuxSystem: 'Intelligent design system generation',
      uiuxPlatforms: 'Multi-platform support (React/Vue/Tailwind)',
      uiuxRules: '100 industry-specific rules',
      tipTitle: 'Usage Tip',
